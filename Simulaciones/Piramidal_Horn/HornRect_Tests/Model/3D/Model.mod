...
'[VERSION]2015.0|24.0.2|20150116[/VERSION]
Pick.PickEndpointFromId "Horn:WGwalls", "4" 


'@ unpick end point

'[VERSION]2015.0|24.0.2|20150116[/VERSION]
Pick.UnpickEndpointFromId "Horn:WGwalls", "4" 


'@ pick end point

'[VERSION]2015.0|24.0.2|20150116[/VERSION]
Pick.PickCurveEndpointFromId "curve1:rectangle1", "1" 
...
With Polygon3D 
     ...
     .Name "3dpolygon1" 
     .Curve "curve1" 
     .Point "xp(1)", "yp(1)", "zp(1)" 
     .Point "-84.375", "-37.5", "37.5" 
     .Create 
End With 


'@ delete curve item: curve1:3dpolygon1

'[VERSION]2015.0|24.0.2|20150116[/VERSION]
Curve.DeleteCurveItem "curve1", "3dpolygon1" 
