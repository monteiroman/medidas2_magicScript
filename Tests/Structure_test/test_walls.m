...
CSX = AddLinPoly( CSX, 'Corrugated_Horn', 10, 1, 0, coords, horn_width, 'Transform', 
                                    {'Rotate_Y', -pi/2,'Translate',[ '0,' num2str(-horn_width/2) ',0']});
CSX = AddLinPoly( CSX, 'Corrugated_Horn', 10, 1, 0, coords, horn_width, 'Transform', 
                                    {'Rotate_Y', pi/2, 'Rotate_X', pi, 'Translate',[ '0,' num2str(horn_width/2) ',0']});
