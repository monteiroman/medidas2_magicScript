...
%                       - default is 5
%   'markersize':       - set the graph markers size
%                       - default is 5
%   example:
...
for n=1:2:numel(varargin)
    ...
    elseif (strcmp(varargin{n},'markersize')==1);
...
handle1 = plot(s11(lowerind),['<', 'b'], 'markersize', markersize, 'Linewidth', linewidth);
handle2 = plot(s11(upperind),['>', 'b'], 'markersize', markersize, 'Linewidth', linewidth);
handle3 = plot(s11(minind),['*', 'b'], 'markersize', markersize, 'Linewidth', linewidth);
